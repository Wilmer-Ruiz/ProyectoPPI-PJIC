...
public class Filtro implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        String tipo = filterConfig.getInitParameter("tipo");

        String paramNombre = request.getParameter("nombre");
        String paramUsuario = request.getParameter("usuario");
        
        DateFormat formato = new SimpleDateFormat("dd/MM/yyyy hh:mm aa");
        String fecha = formato.format(new Date()).toString();
        
        Entradas e = new Entradas(paramNombre, paramUsuario, fecha, tipo);
        
        Ayudas.ingresarEntrada(e);
